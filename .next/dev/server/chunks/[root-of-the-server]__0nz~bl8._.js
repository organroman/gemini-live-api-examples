...
;
;
function withIdentityFlags(status, identity) {
...
function isOrganizerIdentity(requesterIdentity, organizerIdentity) {
    return !!requesterIdentity && requesterIdentity === organizerIdentity;
}
function isSameUser(requesterIdentity, attendeeIdentity) {
...
async function GET(req) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(withIdentityFlags(status, identity));
}
async function POST(req) {
    try {
        ...
        if (action === "request") {
            const attendeeIdentity = body.attendeeIdentity;
            if (!attendeeIdentity) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(withIdentityFlags(status, attendeeIdentity));
        }
        if (action === "cancel") {
            const attendeeIdentity = body.attendeeIdentity;
            if (!attendeeIdentity) {
        ...
        if (action === "approve") {
            const attendeeIdentity = body.attendeeIdentity;
            const organizerTargetLanguage = body.organizerTargetLanguage || "uk";
            if (!attendeeIdentity) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Missing attendeeIdentity"
                }, {
            ...
            const status = await manager.approveQuestion(sessionId, attendeeIdentity, organizerTargetLanguage);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(withIdentityFlags(status, attendeeIdentity));
        }
        if (action === "end") {
            if (!isOrganizerIdentity(requesterIdentity, session.organizerIdentity)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0nz~bl8._.js.map